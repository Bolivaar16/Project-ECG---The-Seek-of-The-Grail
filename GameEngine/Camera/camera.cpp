...
{
	// Flatten direction
	glm::vec3 direction = glm::normalize(glm::vec3(cameraViewDirection.x, 0.0f, cameraViewDirection.z));
...
void Camera::rotateOy(float angle)
{
	...
	// Rotate Yaw
	cameraViewDirection = glm::normalize(glm::vec3(glm::rotate(glm::mat4(1.0f), angle, worldUp) * glm::vec4(cameraViewDirection, 1.0f)));
